...
1. Generate HTML version first at proposal.html — rich tables, color-coded from/to rows, capability cards
2. Print: "Proposal HTML ready — paste into browser: file:///[absolute path]/proposal.html"
