...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'c3spec';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'c3spec';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/c3spec/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/c3spec/
 * - Windows fallback: %APPDATA%/c3spec/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/c3spec/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/c3spec/
 * - Windows fallback: %LOCALAPPDATA%/c3spec/
 */
