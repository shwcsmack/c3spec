...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about C3Spec with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about C3Spec.
...
5. **Submit on confirmation**
   - Use the \`c3spec feedback\` command to submit
   - Format: \`c3spec feedback "title" --body "body content"\`
