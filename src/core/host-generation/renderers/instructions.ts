...
| T2 Lightweight Feature | New capability, clear scope | \`c3spec-propose\` then apply |
| T3 Full Workflow | Design uncertainty, architecture, breaking change | Brainstorm, propose, then apply |
