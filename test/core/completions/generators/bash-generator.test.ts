...
describe('BashGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid bash completion script with header', () => {
      ...
      expect(script).toContain('# Bash completion script for C3Spec CLI');
      expect(script).toContain('_c3spec_completion() {');
    ...
    it('should generate script that ends with complete registration', () => {
      ...
      expect(script.trim().endsWith('complete -F _c3spec_completion c3spec')).toBe(true);
    });
    ...
    it('should handle empty command list', () => {
      ...
      expect(script).toContain('_c3spec_completion() {');
      expect(script).toContain('complete -F _c3spec_completion c3spec');
    });
